...
import { DarkFeatureDefaults } from "@/components/products/origin/DarkFeature";
import { DarkFeature2Defaults } from "@/components/products/origin/DarkFeature2";
import { LightFeatureDefaults } from "@/components/products/origin/LightFeature";

export const originFeaturesType = defineType({
  name: "originFeatures",
  title: "Origin Features",
  type: "document",
  fields: [
    defineField({
      name: "darkFeature",
