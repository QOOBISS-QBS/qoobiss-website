...
import { BannerDefaults } from "@/components/products/omnicheck/Banner";
import { HeroDefaults } from "@/components/products/omnicheck/Hero";
import { OurSolutionDefaults } from "@/components/products/omnicheck/OurSolution";

export const omnicheckType = defineType({
  name: "omnicheck",
  title: "Omnicheck Page",
  type: "document",
  fields: [
    defineField({
      name: "banner",
